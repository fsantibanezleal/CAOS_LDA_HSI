...
def build_for_scene(scene_id: str) -> list[dict]:
    ...
    methods: list[tuple[str, callable]] = [
        ...
        ("nmf_32", lambda s: fit_nmf(np.clip(s, 0.0, None), 32)),
        ("ica_4", lambda s: fit_ica(s, 4)),
        ("ica_8", lambda s: fit_ica(s, 8)),
        ("ica_10", lambda s: fit_ica(s, 10)),
        ("ica_16", lambda s: fit_ica(s, 16)),
        ("ica_32", lambda s: fit_ica(s, 32)),
        ("dense_ae_4", lambda s: fit_dense_ae(s, 4)),
        ("dense_ae_8", lambda s: fit_dense_ae(s, 8)),
        ("dense_ae_16", lambda s: fit_dense_ae(s, 16)),
        ("dense_ae_32", lambda s: fit_dense_ae(s, 32)),
        ("cae_1d_4", lambda s: fit_cae_1d(s, 4)),
        ("cae_1d_6", lambda s: fit_cae_1d(s, 6)),
        ("cae_1d_8", lambda s: fit_cae_1d(s, 8)),
        ("cae_1d_10", lambda s: fit_cae_1d(s, 10)),
        ("cae_1d_12", lambda s: fit_cae_1d(s, 12)),
        ...
        ("beta_vae_b1_8", lambda s: fit_beta_vae(s, 8, beta=1.0)),
        ("beta_vae_b2_8", lambda s: fit_beta_vae(s, 8, beta=2.0)),
        ("beta_vae_b8_8", lambda s: fit_beta_vae(s, 8, beta=8.0)),
        ("beta_vae_b16_8", lambda s: fit_beta_vae(s, 8, beta=16.0)),
