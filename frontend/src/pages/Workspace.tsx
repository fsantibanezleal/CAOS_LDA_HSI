...
import { TabLoading } from "./workspace/components/TabStates";
import {
  RecentlyViewed,
  useTrackRecentScene,
...
const UnmixingTab = lazy(() =>
  import("./workspace/tabs/UnmixingTab").then((m) => ({
    default: m.UnmixingTab,
  })),
);
const RasterTab = lazy(() =>
  import("./workspace/tabs/RasterTab").then((m) => ({
    default: m.RasterTab,
  })),
);
const SpectralBrowserTab = lazy(() =>
  import("./workspace/tabs/SpectralBrowserTab").then((m) => ({
    default: m.SpectralBrowserTab,
  })),
);
const TopicsTab = lazy(() =>
  import("./workspace/tabs/TopicsTab").then((m) => ({
    default: m.TopicsTab,
  })),
);
